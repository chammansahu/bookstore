...
//  import axios from "axios";
 import {
    ...
    USER_REGISTER_SUCCESS, USER_REGISTER_FAIL, USER_SIGNOUT, USER_DETAILS_REQUEST, USER_DETAILS_SUCCESS, USER_DETAILS_FAIL,
    USER_UPDATE_PROFILE_FAIL,
    USER_UPDATE_PROFILE_REQUEST,
    USER_UPDATE_PROFILE_SUCCESS,
    PRODUCT_LIST_REQUESTzz,
    PRODUCT_LIST_SUCCESSzz,
    PRODUCT_LIST_FAILzz,
    USER_LIST_REQUEST,
    USER_LIST_SUCCESS,  
    USER_LIST_FAIL,
...
export const signout = () => (dispatch) => {
  ...
  //   const listUsersjjjj = () => async (dispatch, getState) => {

...
// let sp=mrp*1+ee*1;
 ...
 setSp(sp);
  ...
  const submitHandler=(e)=>{
   ...
   // notify();
   //saveProduct({name, author_name, isbn, sku, fc, book_format, book_language, cat, mrp, selling_price, book_size, page_number,  item_weight, dimension, brand, image, description, unit})
  ...
  return (  
              ...
              <div className="col-md-12">
                ...
                <div className="card card-primary">
                    ...
                    <div className="row">
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" name="name" id="exampleInputEmail1" placeholder=" Book Title" onChange={(e) => setName(e.target.value)} />
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" onChange={(e) => setAuthorName(e.target.value)} name="author_name" id="exampleInputEmail1" placeholder=" Author Name" />
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
                          <label htmlFor="exampleInputPassword1">ISBN No.</label>
                          <input type="text" className="form-control" onChange={(e) => setISBN(e.target.value)} name="isbn" id="exampleInputPassword1" placeholder=" ISBN Number" />
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
                          <label htmlFor="exampleInputPassword1">SKU ID</label>
                          <input type="text" className="form-control" name="sku" onChange={(e) => setSKU(e.target.value)} id="exampleInputPassword1" placeholder=" SKU ID" />
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
                  ...
                  <select class="form-control" name="cat"  onChange={(e) => setCat(e.target.value)} >
                      ...
                      <div className="col-3">
                        <div className="form-group">
                        <label htmlFor="exampleInputPassword1"> Number of Pages</label>
    ...
    <input type="hidden" className="form-control" id="image"  value={image} name="brand"  onChange={(e) => setImage(e.target.value)} readOnly/>
                        </div>
                      </div>
...
<textarea className="form-control" id="description" name="description" onChange={(e) => setDesc(e.target.value)}
